...
app.use((req, res, next) => {
  res.setHeader("Access-Control-Allow-Origin", "https://groupomania-intranet.netlify.app/jwtid"); // d'accéder à notre API depuis n'importe quelle origine ( '*' ) donc tout le monde peut acceder à l'api
  res.setHeader(
